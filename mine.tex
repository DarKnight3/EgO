...
\section{Specific Requirements}
    ...
    \subsection{Functional Requirements}
			\subsection R1 NavUP shall provide the user with navigation functions to navigate the user around campus
				\begin{itemize}
				...
				\end
			\subsection R2 NavUP shall provide the user with a user interface to allow users to enter information
				\begin{itemize}
				...
				\end
			\subsection R3 NavUP shall push new information to the users according to their preference
				\begin{itemize}
					...
					\end
				\end
			\subsection R4 NavUP shall keep record of steps taken by the user around campus.
